    ...
    html: `
      ...
      <body>
        <div class="email-container">
          ...
          <p>We received a request to verify your email for registration. Please use the following One-Time Password (OTP) to verify your identity:</p>
          ...
          <p>If you did not request this email verification, please ignore this email or contact support if you have concerns about your account security.</p>
